  ...
  return (
    <div
      ...
      style={{
        ...
        right: 2,
        height: heightPx,
        background: warnings && warnings.length > 0 ? "rgba(254,226,226,0.92)" : !block.employee_id ? "rgba(255,247,237,0.95)" : "rgba(255,255,255,0.85)",
        border: warnings && warnings.length > 0 ? "1px solid #fca5a5" : !block.employee_id ? "1px solid #fed7aa" : "1px solid #d1d5db",
        borderLeft: `3px solid ${warnings && warnings.length > 0 ? "#ef4444" : !block.employee_id ? "#f97316" : leftBorderColor}`,
        borderRadius: 6,
        padding: "3px 5px",
        overflow: "hidden",
