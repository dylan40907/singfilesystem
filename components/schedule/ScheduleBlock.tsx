  ...
  return (
    <div
      ...
      style={{
        ...
        right: 2,
        height: heightPx,
        background: warnings && warnings.length > 0 ? "rgba(254,226,226,0.92)" : isUnassigned ? "rgba(255,237,213,0.97)" : "rgba(255,255,255,0.85)",
        border: warnings && warnings.length > 0 ? "1px solid #fca5a5" : isUnassigned ? "1.5px solid #fb923c" : "1px solid #d1d5db",
        borderLeft: `3px solid ${warnings && warnings.length > 0 ? "#ef4444" : isUnassigned ? "#ea580c" : leftBorderColor}`,
        borderRadius: 6,
        padding: "3px 5px",
        overflow: "hidden",
