...
export default function HrPage() {
  ...
  type HrTab = "meetings" | "reviews" | "attendance" | "employeeReviews";
  const [activeTab, setActiveTab] = useState<HrTab>("meetings");
...
const [docsByMeeting, setDocsByMeeting] = useState<Map<string, HrMeetingDocument[]>>(new Map());
  ...
  }, [activeTab, employee?.id, isSupervisor, isAdmin, reloadMeetingTypes, reloadAllEmployees, loadAttendeeMeetings]);
      ...
      <div style={{ display: "grid", gap: 14 }}>
        ...
        <div>
          ...
          <div style={{ display: "grid", gap: 14 }}>
            ...
            {activeTab === "meetings" && (isSupervisor || isAdmin) ? (
              <div style={{ border: "1px solid #e5e7eb", borderRadius: 16, padding: 14 }}>
                <div className="row-between" style={{ gap: 12, alignItems: "center" }}>
